...
def send_radius_request():
    try:
        # Generate unique username and password for each request
        mac = generate_random_mac()
        #suffix = '990110000036'
        #username = mac + suffix
        username = mac
        password = username
        print(f"Sending request with username: {username} and password: {password}")
        
        # Send the RADIUS authentication request
...
num_requests = 1000 # Change this to however many requests you want to send
